...
It uses the files inside the folder named “source” (AbstractAnimation.js, HeightMap.js, Model.js, RotationAnimation.js), the images in the folder “textures” (stairs.png, terrain1.png and terrain2.png) and the libraries inside the folder “lib”. 
The project is executed from the page "index.html" located in the main folder.
